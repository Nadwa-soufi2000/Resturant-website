  ...
  return (
    <div className="w-full sm:w-full md:w-full lg:w-full xl:w-[1146px] my-[20px] mx-auto px-4 sm:px-6 md:px-8 lg:px-4 xl:px-0">
      <div className="flex flex-col gap-3 justify-between items-center">
          <div className="w-full sm:w-full md:w-full lg:w-full xl:w-[1086px] h-[50px] flex justify-between items-center">
      ...
      <div className="w-full flex flex-col gap-4 my-[40px] justify-center items-center">
          <div className="w-full sm:w-full md:w-full lg:w-full xl:w-[1046px] h-[48px] flex justify-between items-center px-4 sm:px-0">
            <AddProduct />
          ...
          <div className="bg-[#F5F5F5] w-full flex justify-between items-center">
             <div className="w-full sm:w-full md:w-full lg:w-full xl:w-[1080px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 mx-auto gap-3 pt-4 px-4 sm:px-3 md:px-2 lg:px-3 xl:px-0">
